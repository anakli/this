# Original author: Sadjad Fouladi
...
plot "timing_data" using 2 t "" lc rgb "white", \
                "" using 3 t "Fetch decoder binary" lc rgb "#87cefa", \
                "" using 4 t "Fetching inputs" lc rgb "#377eb8", \
                "" using 5 t "Decoding and Computing" lc rgb "#4daf4a", \
                "" using 6 t "Uploading the results" lc rgb "#e41a1c"
